  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>Estadísticas detalladas y gráficos del día</CardDescription>
      </CardHeader>
          ...
          <div className="space-y-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">Vehículos Total</p>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">Nocturnos</p>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">Diurnos</p>
            ...
            <Tabs defaultValue="distribucion" className="w-full">
              ...
              <TabsContent value="distribucion" className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <Card>
                    ...
                    <CardContent>
                      {chartData && renderPieChart(chartData.distribucionVehiculos, "Vehículos por Tipo")}
                    </CardContent>
                  </Card>
              ...
              <TabsContent value="horas">
                <Card>
                  <CardHeader>
                    <CardTitle className="text-base">Horas Pico de Entrada</CardTitle>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="espacios">
                <Card>
                  <CardHeader>
                    <CardTitle className="text-base">Espacios Más Utilizados</CardTitle>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="tiempo">
                <Card>
                  <CardHeader>
                    <CardTitle className="text-base">Distribución de Tiempo de Estacionamiento</CardTitle>
                  </CardHeader>
                  <CardContent>
